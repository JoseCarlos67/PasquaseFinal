...
public class FrmPrincipal extends javax.swing.JFrame {
        ...
        while (true) {
            ...
            switch (token) {
                ...
                case pv:
                    ...
                    break;
                case pf:
                    resultado += "  <Ponto final>\t" + lexer.lexeme + "\n";
                    break;
                case id:
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Analisador Léxico", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 18))); // NOI18N
        ...
        jPanel1.getAccessibleContext().setAccessibleName("Analisador Lexico");
    ...
    private void btnAnalizarSinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnalizarSinActionPerformed
        ...
        try {
            s.parse();
            txtAnalizarSin.setText("Análise realizada com sucesso!");
            txtAnalizarSin.setForeground(new Color(25, 111, 61));
        } catch (Exception ex) {
            Symbol sym = s.getS();
            txtAnalizarSin.setText("Erro de sintaxe. Linha: " + (sym.right + 1) + " Columna: " + (sym.left + 1) + ", Texto: \"" + sym.value + "\"");
